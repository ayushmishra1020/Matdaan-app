...
if __name__ == "__main__":
    os.environ['HADOOP_HOME'] = "D:/Projects/winutils/hadoop-3.2.2"
    sys.path.append("D:/Projects/winutils/hadoop-3.2.2/bin")
    ...
    votes_df_read = spark.readStream \
        .format("kafka") \
    ...
    # query = votes_df_read.writeStream.format("console").start()
    # import time
    #
    ...
    votes_df = votes_df_read.withColumn("voting_time", col("voting_time").cast(TimestampType())) \
