...
if __name__ == "__main__":
    ...
    if len(candidates) == 0:
        for i in range(3):
            candidate = generate_candidate_data_static(i, 3)
            print(candidate)
            cur.execute("""
